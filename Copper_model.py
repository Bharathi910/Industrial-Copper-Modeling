...
if selected=='HOME':
    ...
    st.write("### :violet[ML MODELS USED]")
    st.write('#### :violet[REGRESSION] - ***:orange[ExtraTreeRegressor]***')
    ...
    st.write('#### :violet[CLASSIFICATION] - ***:orange[RandomForestClassification]***')
        ...
        if 'STATUS PREDICTION':
            ...
            with cc1:
                ...
                if st.button('PREDICT STATUS'):
                    with st.spinner(':Green[Predicting....]'):
                        data_cls = []
                        with open('country.pkl', 'rb') as file:
